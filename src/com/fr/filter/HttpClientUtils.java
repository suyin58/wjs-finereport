...
public class HttpClientUtils {
	...
	private static HttpClient getSSLHttpClient() {
		...
		try {
			sslContext = new SSLContextBuilder().useSSL().loadTrustMaterial(null, new TrustStrategy() {
				@Override
		...
		//fix hostname in certificate didn't match
	...
	public static void main(String[] args) {
		...
		// System.out.println(HttpClientUtils.postWithoutException("http://sh1.api.int.nuomi.com/usercenter/api/getInfoById?id=1416063932268213",
		// new HashMap<String, Object>(){
		// {
		// put("id", "1416063932268213");
		// }
		// }));
	}
}
